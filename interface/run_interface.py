...
def render(predictions, verdicts, exchanges, agg, findings) -> str:
...
def main() -> None:
    ...
    (out / "interface_report.md").write_text(
        render(predictions, verdicts, exchanges, agg, findings), encoding="utf-8")
